// Forked from https://github.com/mholt/caddy fastcgi client
// which is forked from http://bitbucket.org/PinIdea/fcgi_client
// and which is forked from https://code.google.com/p/go-fastcgi-client/
